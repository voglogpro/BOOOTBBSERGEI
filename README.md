...
- сделки со статусом, сессией, сетапом, оценкой качества, ценами, риском, P/L, R, эмоциями и ошибками;
...
- кривая капитала, наблюдения по повторяющимся ошибкам и экспорт CSV;
