...
CREATE TABLE IF NOT EXISTS trades (
    ...
    countertrend_evidence TEXT NOT NULL DEFAULT '',
    trigger_confirmed INTEGER CHECK (trigger_confirmed IS NULL OR trigger_confirmed IN (0, 1)),
    trigger_evidence TEXT NOT NULL DEFAULT '',
    entered_without_plan INTEGER NOT NULL DEFAULT 0 CHECK (entered_without_plan IN (0, 1)),
    entry_price REAL,
    stop_loss REAL,
    take_profit REAL,
    volume REAL,
